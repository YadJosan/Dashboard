...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Site>().Property(p => p.Name).IsRequired().HasMaxLength(200);
            builder.Entity<Site>().Property(p => p.Url).HasMaxLength(500);
            builder.Entity<Site>().Property(p => p.Description).HasMaxLength(500);
            builder.Entity<Site>().ToTable($"App{nameof(this.Sites)}");
        }
